...
const FAQs = () => {
  return (
    <div className="max-w-4xl flex justify-center flex-col mx-auto space-y-4">
      ...
      <button className="mt-12 border-none w-full sm:w-[50%] m-auto sora bg-[#2c65ca] cursor-pointer border sm:text-lg text-sm hover:-translate-y-2.5 hover:bg-[#5b94eb] duration-500 text-white font-semibold py-4 px-5 rounded-full transition">
